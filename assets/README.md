...
## Local Deploy Refresh

To rebuild the website and refresh the separate `github/` static deploy folder, run:

```bash
zsh tool/refresh_github_deploy.sh
```

This keeps the Flutter source app in the project root and updates only the generated GitHub Pages output inside [github](/Users/shadow/development/apps/dexpro/github).
